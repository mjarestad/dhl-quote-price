...
/**
 * This class stands for GetQuotableAccountResult StructType
 * @subpackage Structs
 */
class GetQuotableAccountResult extends AbstractStructBase
{
    /**
     * The QAResponseRow
    ...
    /**
     * Constructor method for GetQuotableAccountResult
     * @uses GetQuotableAccountResult::setQAResponseRow()
    ...
    public static function validateQAResponseRowForArrayConstraintsFromSetQAResponseRow(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $getQuotableAccountResultQAResponseRowItem) {
            // validation for constraint: itemType
            if (!$getQuotableAccountResultQAResponseRowItem instanceof \Mjarestad\DHL\QuotePrice\StructType\QAResponseRow) {
                $invalidValues[] = is_object($getQuotableAccountResultQAResponseRowItem) ? get_class($getQuotableAccountResultQAResponseRowItem) : sprintf('%s(%s)', gettype($getQuotableAccountResultQAResponseRowItem), var_export($getQuotableAccountResultQAResponseRowItem, true));
            }
        }
     ...
     * @param \Mjarestad\DHL\QuotePrice\StructType\QAResponseRow[] $qAResponseRow
     * @return \Mjarestad\DHL\QuotePrice\StructType\GetQuotableAccountResult
     */
