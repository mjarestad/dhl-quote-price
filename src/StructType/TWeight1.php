...
/**
 * This class stands for tWeight1 StructType
 * @subpackage Structs
 */
class TWeight1 extends AbstractStructBase
{
    /**
     * The unit
    ...
    public $_;
    /**
     * Constructor method for tWeight1
     * @uses TWeight1::setUnit()
     * @uses TWeight1::set_()
     * @param string $unit
     * @param float $_
     */
     ...
     * @param string $unit
     * @return \Mjarestad\DHL\QuotePrice\StructType\TWeight1
     */
