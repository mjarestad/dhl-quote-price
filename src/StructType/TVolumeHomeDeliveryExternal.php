...
/**
 * This class stands for tVolumeHomeDeliveryExternal StructType
 * @subpackage Structs
 */
class TVolumeHomeDeliveryExternal extends AbstractStructBase
{
    /**
     * The unit
    ...
    public $_;
    /**
     * Constructor method for tVolumeHomeDeliveryExternal
     * @uses TVolumeHomeDeliveryExternal::setUnit()
     * @uses TVolumeHomeDeliveryExternal::set_()
     * @param string $unit
     * @param float $_
     */
     ...
     * @param string $unit
     * @return \Mjarestad\DHL\QuotePrice\StructType\TVolumeHomeDeliveryExternal
     */
