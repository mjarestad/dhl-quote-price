...
/**
 * This class stands for tWeight3 StructType
 * @subpackage Structs
 */
class TWeight3 extends AbstractStructBase
{
    /**
     * The unit
    ...
    public $_;
    /**
     * Constructor method for tWeight3
     * @uses TWeight3::setUnit()
     * @uses TWeight3::set_()
     * @param string $unit
     * @param float $_
     */
     ...
     * @param string $unit
     * @return \Mjarestad\DHL\QuotePrice\StructType\TWeight3
     */
