...
/**
 * This class stands for tEurapid StructType
 * @subpackage Structs
 */
class TEurapid extends AbstractStructBase
{
    /**
     * The AgreementNo
     ...
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var \Mjarestad\DHL\QuotePrice\StructType\TSenderReceiver_ER
     */
    ...
    public $OwnSurCharge;
    /**
     * Constructor method for tEurapid
     * @uses TEurapid::setAgreementNo()
     * @uses TEurapid::setSenderReceiver()
     * @uses TEurapid::setDimensions()
     * @uses TEurapid::setOptions()
     * @uses TEurapid::setOwnSurCharge()
     * @param string $agreementNo
     * @param \Mjarestad\DHL\QuotePrice\StructType\TSenderReceiver_ER $senderReceiver
     ...
     * @param string $agreementNo
     * @return \Mjarestad\DHL\QuotePrice\StructType\TEurapid
     */
     ...
     * @return \Mjarestad\DHL\QuotePrice\StructType\TSenderReceiver_ER|null
     */
     ...
     * @return \Mjarestad\DHL\QuotePrice\StructType\TEurapid
     */
    public function setSenderReceiver(\Mjarestad\DHL\QuotePrice\StructType\TSenderReceiver_ER $senderReceiver = null)
    {
