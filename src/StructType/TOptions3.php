...
/**
 * This class stands for tOptions3 StructType
 * @subpackage Structs
 */
class TOptions3 extends AbstractStructBase
{
    /**
     * The Dangerous
    ...
    /**
     * Constructor method for tOptions3
     * @uses TOptions3::setDangerous()
     * @uses TOptions3::setGuarantee()
     * @uses TOptions3::setPreAdvice()
     * @uses TOptions3::setPreAdviceComType()
     * @uses TOptions3::setDeliveryAdvice()
     * @uses TOptions3::setInCarriage()
     * @uses TOptions3::setRecPays()
     * @uses TOptions3::setThirdPtyPays()
     * @uses TOptions3::setCOD()
     * @uses TOptions3::setWarm()
     * @uses TOptions3::setInsurance()
     * @uses TOptions3::setLQ_DangerousGoods()
     * @uses TOptions3::setDeliveryWithoutPOD()
     * @uses TOptions3::setPickupAtTerminal()
     * @uses TOptions3::setCO2ClimateCompensation()
     ...
     * Set Dangerous value
     * @param bool $dangerous
     * @return \Mjarestad\DHL\QuotePrice\StructType\TOptions3
     */
