...
/**
 * This class stands for tWeight5 StructType
 * @subpackage Structs
 */
class TWeight5 extends AbstractStructBase
{
    /**
     * The unit
    ...
    public $_;
    /**
     * Constructor method for tWeight5
     * @uses TWeight5::setUnit()
     * @uses TWeight5::set_()
     * @param string $unit
     * @param float $_
     */
     ...
     * @param string $unit
     * @return \Mjarestad\DHL\QuotePrice\StructType\TWeight5
     */
