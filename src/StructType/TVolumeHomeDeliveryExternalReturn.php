...
/**
 * This class stands for tVolumeHomeDeliveryExternalReturn StructType
 * @subpackage Structs
 */
class TVolumeHomeDeliveryExternalReturn extends AbstractStructBase
{
    /**
     * The unit
    ...
    public $_;
    /**
     * Constructor method for tVolumeHomeDeliveryExternalReturn
     * @uses TVolumeHomeDeliveryExternalReturn::setUnit()
     * @uses TVolumeHomeDeliveryExternalReturn::set_()
     * @param string $unit
     * @param float $_
     */
     ...
     * @param string $unit
     * @return \Mjarestad\DHL\QuotePrice\StructType\TVolumeHomeDeliveryExternalReturn
     */
