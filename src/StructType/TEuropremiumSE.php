...
/**
 * This class stands for tEuropremiumSE StructType
 * @subpackage Structs
 */
class TEuropremiumSE extends AbstractStructBase
{
    /**
     * The AgreementNo
    ...
    public $OwnSurCharge;
    /**
     * Constructor method for tEuropremiumSE
     * @uses TEuropremiumSE::setAgreementNo()
     * @uses TEuropremiumSE::setWeight()
     * @uses TEuropremiumSE::setVolume()
     * @uses TEuropremiumSE::setSenderReceiver()
     * @uses TEuropremiumSE::setValues()
     * @uses TEuropremiumSE::setOptions()
     * @uses TEuropremiumSE::setOwnSurCharge()
     ...
     * @param string $agreementNo
     * @return \Mjarestad\DHL\QuotePrice\StructType\TEuropremiumSE
     */
