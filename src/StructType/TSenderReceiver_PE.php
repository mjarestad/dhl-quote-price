...
/**
 * This class stands for tSenderReceiver_PE StructType
 * @subpackage Structs
 */
class TSenderReceiver_PE extends AbstractStructBase
{
    /**
     * The FromCountryCode
    ...
    public $ToPostCode;
    /**
     * Constructor method for tSenderReceiver_PE
     * @uses TSenderReceiver_PE::setFromCountryCode()
     * @uses TSenderReceiver_PE::setFromPostCode()
     * @uses TSenderReceiver_PE::setToCountryCode()
     * @uses TSenderReceiver_PE::setToPostCode()
     ...
     * @param string $fromCountryCode
     * @return \Mjarestad\DHL\QuotePrice\StructType\TSenderReceiver_PE
     */
