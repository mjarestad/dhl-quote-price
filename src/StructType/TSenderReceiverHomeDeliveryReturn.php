...
/**
 * This class stands for tSenderReceiverHomeDeliveryReturn StructType
 * @subpackage Structs
 */
class TSenderReceiverHomeDeliveryReturn extends AbstractStructBase
{
    /**
     * The FromPostCode
    ...
    public $ToCity;
    /**
     * Constructor method for tSenderReceiverHomeDeliveryReturn
     * @uses TSenderReceiverHomeDeliveryReturn::setFromPostCode()
     * @uses TSenderReceiverHomeDeliveryReturn::setFromCity()
     * @uses TSenderReceiverHomeDeliveryReturn::setToPostCode()
     * @uses TSenderReceiverHomeDeliveryReturn::setToCity()
     ...
     * @param string $fromPostCode
     * @return \Mjarestad\DHL\QuotePrice\StructType\TSenderReceiverHomeDeliveryReturn
     */
