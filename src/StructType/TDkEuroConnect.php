...
/**
 * This class stands for tDkEuroConnect StructType
 * @subpackage Structs
 */
class TDkEuroConnect extends AbstractStructBase
{
    /**
     * The AgreementNo
    ...
    public $OwnSurCharge;
    /**
     * Constructor method for tDkEuroConnect
     * @uses TDkEuroConnect::setAgreementNo()
     * @uses TDkEuroConnect::setSenderReceiver()
     * @uses TDkEuroConnect::setDimensions()
     * @uses TDkEuroConnect::setOptions()
     * @uses TDkEuroConnect::setOwnSurCharge()
     ...
     * @param string $agreementNo
     * @return \Mjarestad\DHL\QuotePrice\StructType\TDkEuroConnect
     */
