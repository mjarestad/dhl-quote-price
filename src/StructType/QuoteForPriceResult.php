...
/**
 * This class stands for QuoteForPriceResult StructType
 * @subpackage Structs
 */
class QuoteForPriceResult extends AbstractStructBase
{
    /**
     * The ResponseRow
    ...
    public $ResponseRow;
    /**
     * Constructor method for QuoteForPriceResult
     * @uses QuoteForPriceResult::setResponseRow()
    ...
    public static function validateResponseRowForArrayConstraintsFromSetResponseRow(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $quoteForPriceResultResponseRowItem) {
            // validation for constraint: itemType
            if (!$quoteForPriceResultResponseRowItem instanceof \Mjarestad\DHL\QuotePrice\StructType\ResponseRow) {
                $invalidValues[] = is_object($quoteForPriceResultResponseRowItem) ? get_class($quoteForPriceResultResponseRowItem) : sprintf('%s(%s)', gettype($quoteForPriceResultResponseRowItem), var_export($quoteForPriceResultResponseRowItem, true));
            }
        }
     ...
     * @param \Mjarestad\DHL\QuotePrice\StructType\ResponseRow[] $responseRow
     * @return \Mjarestad\DHL\QuotePrice\StructType\QuoteForPriceResult
     */
