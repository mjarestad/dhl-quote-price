...
/**
 * This class stands for tWeightHomeDelivery StructType
 * @subpackage Structs
 */
class TWeightHomeDelivery extends AbstractStructBase
{
    /**
     * The unit
    ...
    public $_;
    /**
     * Constructor method for tWeightHomeDelivery
     * @uses TWeightHomeDelivery::setUnit()
     * @uses TWeightHomeDelivery::set_()
     * @param string $unit
     * @param float $_
     */
     ...
     * @param string $unit
     * @return \Mjarestad\DHL\QuotePrice\StructType\TWeightHomeDelivery
     */
