...
/**
 * This class stands for tValuesHomeDelivery StructType
 * @subpackage Structs
 */
class TValuesHomeDelivery extends AbstractStructBase
{
    /**
     * The NoOfItems
    ...
    public $NoOfItems;
    /**
     * Constructor method for tValuesHomeDelivery
     * @uses TValuesHomeDelivery::setNoOfItems()
     * @param int $noOfItems
     */
     ...
     * Set NoOfItems value
     * @param int $noOfItems
     * @return \Mjarestad\DHL\QuotePrice\StructType\TValuesHomeDelivery
     */
