...
/**
 * This class stands for tSenderReceiverHomeDeliveryExternal StructType
 * @subpackage Structs
 */
class TSenderReceiverHomeDeliveryExternal extends AbstractStructBase
{
    /**
     * The FromPostCode
    ...
    public $ToCity;
    /**
     * Constructor method for tSenderReceiverHomeDeliveryExternal
     * @uses TSenderReceiverHomeDeliveryExternal::setFromPostCode()
     * @uses TSenderReceiverHomeDeliveryExternal::setFromCity()
     * @uses TSenderReceiverHomeDeliveryExternal::setToPostCode()
     * @uses TSenderReceiverHomeDeliveryExternal::setToCity()
     ...
     * @param string $fromPostCode
     * @return \Mjarestad\DHL\QuotePrice\StructType\TSenderReceiverHomeDeliveryExternal
     */
