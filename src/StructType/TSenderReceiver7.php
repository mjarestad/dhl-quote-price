...
/**
 * This class stands for tSenderReceiver7 StructType
 * @subpackage Structs
 */
class TSenderReceiver7 extends AbstractStructBase
{
    /**
     * The FromPostCode
    ...
    public $FromCity;
    /**
     * Constructor method for tSenderReceiver7
     * @uses TSenderReceiver7::setFromPostCode()
     * @uses TSenderReceiver7::setFromCity()
     ...
     * @param string $fromPostCode
     * @return \Mjarestad\DHL\QuotePrice\StructType\TSenderReceiver7
     */
