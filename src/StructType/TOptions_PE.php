...
/**
 * This class stands for tOptions_PE StructType
 * @subpackage Structs
 */
class TOptions_PE extends AbstractStructBase
{
    /**
     * The Insurance
     ...
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var \Mjarestad\DHL\QuotePrice\StructType\TInsurance_PE
     */
    public $Insurance;
    /**
     * The Combiterm
    ...
    /**
     * Constructor method for tOptions_PE
     * @uses TOptions_PE::setInsurance()
     * @uses TOptions_PE::setCombiterm()
     * @uses TOptions_PE::setDeliveryAdvice()
     * @uses TOptions_PE::setCO2ClimateCompensation()
     * @uses TOptions_PE::setCustomsHandling()
     * @uses TOptions_PE::setNumberOfItems()
     * @param \Mjarestad\DHL\QuotePrice\StructType\TInsurance_PE $insurance
     ...
     */
    public function __construct(\Mjarestad\DHL\QuotePrice\StructType\TInsurance_PE $insurance = null, $combiterm = null, $deliveryAdvice = false, $cO2ClimateCompensation = false, $customsHandling = null, $numberOfItems = null)
    {
        $this
    ...
    /**
     * Get Insurance value
     * @return \Mjarestad\DHL\QuotePrice\StructType\TInsurance_PE|null
     */
     ...
     * Set Insurance value
     * @param \Mjarestad\DHL\QuotePrice\StructType\TInsurance_PE $insurance
     * @return \Mjarestad\DHL\QuotePrice\StructType\TOptions_PE
     */
    public function setInsurance(\Mjarestad\DHL\QuotePrice\StructType\TInsurance_PE $insurance = null)
    {
     ...
     * @uses \Mjarestad\DHL\QuotePrice\EnumType\TCombiterms_PE::valueIsValid()
     * @uses \Mjarestad\DHL\QuotePrice\EnumType\TCombiterms_PE::getValidValues()
    ...
    public function setCombiterm($combiterm = null)
    {
        ...
        if (!\Mjarestad\DHL\QuotePrice\EnumType\TCombiterms_PE::valueIsValid($combiterm)) {
            throw new \InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Mjarestad\DHL\QuotePrice\EnumType\TCombiterms_PE', is_array($combiterm) ? implode(', ', $combiterm) : var_export($combiterm, true), implode(', ', \Mjarestad\DHL\QuotePrice\EnumType\TCombiterms_PE::getValidValues())), __LINE__);
        }
     ...
     * This property is removable from request (nillable=true+minOccurs=0), therefore
     * if the value assigned to this property is null, it is removed from this object
     * @uses \Mjarestad\DHL\QuotePrice\EnumType\TCustomsHandling_PE::valueIsValid()
     * @uses \Mjarestad\DHL\QuotePrice\EnumType\TCustomsHandling_PE::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $customsHandling
     * @return \Mjarestad\DHL\QuotePrice\StructType\TOptions_PE
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Mjarestad\DHL\QuotePrice\EnumType\TCustomsHandling_PE::valueIsValid($customsHandling)) {
            throw new \InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Mjarestad\DHL\QuotePrice\EnumType\TCustomsHandling_PE', is_array($customsHandling) ? implode(', ', $customsHandling) : var_export($customsHandling, true), implode(', ', \Mjarestad\DHL\QuotePrice\EnumType\TCustomsHandling_PE::getValidValues())), __LINE__);
        }
