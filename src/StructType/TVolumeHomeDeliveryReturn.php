...
/**
 * This class stands for tVolumeHomeDeliveryReturn StructType
 * @subpackage Structs
 */
class TVolumeHomeDeliveryReturn extends AbstractStructBase
{
    /**
     * The unit
    ...
    public $_;
    /**
     * Constructor method for tVolumeHomeDeliveryReturn
     * @uses TVolumeHomeDeliveryReturn::setUnit()
     * @uses TVolumeHomeDeliveryReturn::set_()
     * @param string $unit
     * @param float $_
     */
     ...
     * @param string $unit
     * @return \Mjarestad\DHL\QuotePrice\StructType\TVolumeHomeDeliveryReturn
     */
