...
/**
 * This class stands for tSenderReceiverHomeDelivery StructType
 * @subpackage Structs
 */
class TSenderReceiverHomeDelivery extends AbstractStructBase
{
    /**
     * The FromPostCode
    ...
    public $ToCity;
    /**
     * Constructor method for tSenderReceiverHomeDelivery
     * @uses TSenderReceiverHomeDelivery::setFromPostCode()
     * @uses TSenderReceiverHomeDelivery::setFromCity()
     * @uses TSenderReceiverHomeDelivery::setToPostCode()
     * @uses TSenderReceiverHomeDelivery::setToCity()
     ...
     * @param string $fromPostCode
     * @return \Mjarestad\DHL\QuotePrice\StructType\TSenderReceiverHomeDelivery
     */
