...
/**
 * This class stands for tWeightHomeDeliveryExternalReturn StructType
 * @subpackage Structs
 */
class TWeightHomeDeliveryExternalReturn extends AbstractStructBase
{
    /**
     * The unit
    ...
    public $_;
    /**
     * Constructor method for tWeightHomeDeliveryExternalReturn
     * @uses TWeightHomeDeliveryExternalReturn::setUnit()
     * @uses TWeightHomeDeliveryExternalReturn::set_()
     * @param string $unit
     * @param float $_
     */
     ...
     * @param string $unit
     * @return \Mjarestad\DHL\QuotePrice\StructType\TWeightHomeDeliveryExternalReturn
     */
