...
/**
 * This class stands for tWeight4 StructType
 * @subpackage Structs
 */
class TWeight4 extends AbstractStructBase
{
    /**
     * The unit
    ...
    public $_;
    /**
     * Constructor method for tWeight4
     * @uses TWeight4::setUnit()
     * @uses TWeight4::set_()
     * @param string $unit
     * @param float $_
     */
     ...
     * @param string $unit
     * @return \Mjarestad\DHL\QuotePrice\StructType\TWeight4
     */
