...
/**
 * This class stands for tDkEuroConnectDomestic StructType
 * @subpackage Structs
 */
class TDkEuroConnectDomestic extends AbstractStructBase
{
    /**
     * The AgreementNo
    ...
    public $OwnSurCharge;
    /**
     * Constructor method for tDkEuroConnectDomestic
     * @uses TDkEuroConnectDomestic::setAgreementNo()
     * @uses TDkEuroConnectDomestic::setSenderReceiver()
     * @uses TDkEuroConnectDomestic::setDimensions()
     * @uses TDkEuroConnectDomestic::setOptions()
     * @uses TDkEuroConnectDomestic::setOwnSurCharge()
     ...
     * @param string $agreementNo
     * @return \Mjarestad\DHL\QuotePrice\StructType\TDkEuroConnectDomestic
     */
