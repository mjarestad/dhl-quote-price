...
/**
 * This class stands for tVolume7 StructType
 * @subpackage Structs
 */
class TVolume7 extends AbstractStructBase
{
    /**
     * The unit
    ...
    public $_;
    /**
     * Constructor method for tVolume7
     * @uses TVolume7::setUnit()
     * @uses TVolume7::set_()
     * @param string $unit
     * @param float $_
     */
     ...
     * @param string $unit
     * @return \Mjarestad\DHL\QuotePrice\StructType\TVolume7
     */
