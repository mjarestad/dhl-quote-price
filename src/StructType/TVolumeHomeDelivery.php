...
/**
 * This class stands for tVolumeHomeDelivery StructType
 * @subpackage Structs
 */
class TVolumeHomeDelivery extends AbstractStructBase
{
    /**
     * The unit
    ...
    public $_;
    /**
     * Constructor method for tVolumeHomeDelivery
     * @uses TVolumeHomeDelivery::setUnit()
     * @uses TVolumeHomeDelivery::set_()
     * @param string $unit
     * @param float $_
     */
     ...
     * @param string $unit
     * @return \Mjarestad\DHL\QuotePrice\StructType\TVolumeHomeDelivery
     */
