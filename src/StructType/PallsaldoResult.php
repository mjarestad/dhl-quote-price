...
/**
 * This class stands for PallsaldoResult StructType
 * @subpackage Structs
 */
class PallsaldoResult extends AbstractStructBase
{
    /**
     * The schema
    ...
    public $any;
    /**
     * Constructor method for PallsaldoResult
     * @uses PallsaldoResult::setSchema()
     * @uses PallsaldoResult::setAny()
     ...
     * @uses \DOMNode::item()
     * @param \DOMDocument $schema
     * @return \Mjarestad\DHL\QuotePrice\StructType\PallsaldoResult
     */
