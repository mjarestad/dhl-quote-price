...
/**
 * This class stands for tWeight2 StructType
 * @subpackage Structs
 */
class TWeight2 extends AbstractStructBase
{
    /**
     * The unit
    ...
    public $_;
    /**
     * Constructor method for tWeight2
     * @uses TWeight2::setUnit()
     * @uses TWeight2::set_()
     * @param string $unit
     * @param float $_
     */
     ...
     * @param string $unit
     * @return \Mjarestad\DHL\QuotePrice\StructType\TWeight2
     */
