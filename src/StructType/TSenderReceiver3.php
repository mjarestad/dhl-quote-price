...
/**
 * This class stands for tSenderReceiver3 StructType
 * @subpackage Structs
 */
class TSenderReceiver3 extends AbstractStructBase
{
    /**
     * The FromPostCode
    ...
    public $ToCity;
    /**
     * Constructor method for tSenderReceiver3
     * @uses TSenderReceiver3::setFromPostCode()
     * @uses TSenderReceiver3::setFromCity()
     * @uses TSenderReceiver3::setToPostCode()
     * @uses TSenderReceiver3::setToCity()
     ...
     * @param string $fromPostCode
     * @return \Mjarestad\DHL\QuotePrice\StructType\TSenderReceiver3
     */
