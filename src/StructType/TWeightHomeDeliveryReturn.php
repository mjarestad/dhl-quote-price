...
/**
 * This class stands for tWeightHomeDeliveryReturn StructType
 * @subpackage Structs
 */
class TWeightHomeDeliveryReturn extends AbstractStructBase
{
    /**
     * The unit
    ...
    public $_;
    /**
     * Constructor method for tWeightHomeDeliveryReturn
     * @uses TWeightHomeDeliveryReturn::setUnit()
     * @uses TWeightHomeDeliveryReturn::set_()
     * @param string $unit
     * @param float $_
     */
     ...
     * @param string $unit
     * @return \Mjarestad\DHL\QuotePrice\StructType\TWeightHomeDeliveryReturn
     */
