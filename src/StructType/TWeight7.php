...
/**
 * This class stands for tWeight7 StructType
 * @subpackage Structs
 */
class TWeight7 extends AbstractStructBase
{
    /**
     * The unit
    ...
    public $_;
    /**
     * Constructor method for tWeight7
     * @uses TWeight7::setUnit()
     * @uses TWeight7::set_()
     * @param string $unit
     * @param float $_
     */
     ...
     * @param string $unit
     * @return \Mjarestad\DHL\QuotePrice\StructType\TWeight7
     */
