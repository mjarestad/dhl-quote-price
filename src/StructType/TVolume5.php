...
/**
 * This class stands for tVolume5 StructType
 * @subpackage Structs
 */
class TVolume5 extends AbstractStructBase
{
    /**
     * The unit
    ...
    public $_;
    /**
     * Constructor method for tVolume5
     * @uses TVolume5::setUnit()
     * @uses TVolume5::set_()
     * @param string $unit
     * @param float $_
     */
     ...
     * @param string $unit
     * @return \Mjarestad\DHL\QuotePrice\StructType\TVolume5
     */
