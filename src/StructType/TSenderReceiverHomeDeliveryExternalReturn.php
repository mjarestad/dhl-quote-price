...
/**
 * This class stands for tSenderReceiverHomeDeliveryExternalReturn StructType
 * @subpackage Structs
 */
class TSenderReceiverHomeDeliveryExternalReturn extends AbstractStructBase
{
    /**
     * The FromPostCode
    ...
    public $ToCity;
    /**
     * Constructor method for tSenderReceiverHomeDeliveryExternalReturn
     * @uses TSenderReceiverHomeDeliveryExternalReturn::setFromPostCode()
     * @uses TSenderReceiverHomeDeliveryExternalReturn::setFromCity()
     * @uses TSenderReceiverHomeDeliveryExternalReturn::setToPostCode()
     * @uses TSenderReceiverHomeDeliveryExternalReturn::setToCity()
     ...
     * @param string $fromPostCode
     * @return \Mjarestad\DHL\QuotePrice\StructType\TSenderReceiverHomeDeliveryExternalReturn
     */
