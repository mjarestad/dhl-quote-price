...
/**
 * This class stands for tWeightLG StructType
 * @subpackage Structs
 */
class TWeightLG extends AbstractStructBase
{
    /**
     * The unit
    ...
    public $_;
    /**
     * Constructor method for tWeightLG
     * @uses TWeightLG::setUnit()
     * @uses TWeightLG::set_()
     * @param string $unit
     * @param float $_
     */
     ...
     * @param string $unit
     * @return \Mjarestad\DHL\QuotePrice\StructType\TWeightLG
     */
