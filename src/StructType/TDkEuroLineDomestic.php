...
/**
 * This class stands for tDkEuroLineDomestic StructType
 * @subpackage Structs
 */
class TDkEuroLineDomestic extends AbstractStructBase
{
    /**
     * The AgreementNo
    ...
    public $OwnSurCharge;
    /**
     * Constructor method for tDkEuroLineDomestic
     * @uses TDkEuroLineDomestic::setAgreementNo()
     * @uses TDkEuroLineDomestic::setSenderReceiver()
     * @uses TDkEuroLineDomestic::setDimensions()
     * @uses TDkEuroLineDomestic::setOptions()
     * @uses TDkEuroLineDomestic::setOwnSurCharge()
     ...
     * @param string $agreementNo
     * @return \Mjarestad\DHL\QuotePrice\StructType\TDkEuroLineDomestic
     */
