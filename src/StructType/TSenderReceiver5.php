...
/**
 * This class stands for tSenderReceiver5 StructType
 * @subpackage Structs
 */
class TSenderReceiver5 extends AbstractStructBase
{
    /**
     * The FromPostCode
    ...
    public $ToCity;
    /**
     * Constructor method for tSenderReceiver5
     * @uses TSenderReceiver5::setFromPostCode()
     * @uses TSenderReceiver5::setFromCity()
     * @uses TSenderReceiver5::setToPostCode()
     * @uses TSenderReceiver5::setToCity()
     ...
     * @param string $fromPostCode
     * @return \Mjarestad\DHL\QuotePrice\StructType\TSenderReceiver5
     */
