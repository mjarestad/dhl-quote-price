...
/**
 * This class stands for tVolume2 StructType
 * @subpackage Structs
 */
class TVolume2 extends AbstractStructBase
{
    /**
     * The unit
    ...
    public $_;
    /**
     * Constructor method for tVolume2
     * @uses TVolume2::setUnit()
     * @uses TVolume2::set_()
     * @param string $unit
     * @param float $_
     */
     ...
     * @param string $unit
     * @return \Mjarestad\DHL\QuotePrice\StructType\TVolume2
     */
