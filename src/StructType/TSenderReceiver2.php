...
/**
 * This class stands for tSenderReceiver2 StructType
 * @subpackage Structs
 */
class TSenderReceiver2 extends AbstractStructBase
{
    /**
     * The FromPostCode
    ...
    public $ToCity;
    /**
     * Constructor method for tSenderReceiver2
     * @uses TSenderReceiver2::setFromPostCode()
     * @uses TSenderReceiver2::setFromCity()
     * @uses TSenderReceiver2::setToPostCode()
     * @uses TSenderReceiver2::setToCity()
     ...
     * @param string $fromPostCode
     * @return \Mjarestad\DHL\QuotePrice\StructType\TSenderReceiver2
     */
