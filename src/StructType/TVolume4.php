...
/**
 * This class stands for tVolume4 StructType
 * @subpackage Structs
 */
class TVolume4 extends AbstractStructBase
{
    /**
     * The unit
    ...
    public $_;
    /**
     * Constructor method for tVolume4
     * @uses TVolume4::setUnit()
     * @uses TVolume4::set_()
     * @param string $unit
     * @param float $_
     */
     ...
     * @param string $unit
     * @return \Mjarestad\DHL\QuotePrice\StructType\TVolume4
     */
