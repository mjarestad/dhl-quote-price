...
/**
 * This class stands for tWeightHomeDeliveryExternal StructType
 * @subpackage Structs
 */
class TWeightHomeDeliveryExternal extends AbstractStructBase
{
    /**
     * The unit
    ...
    public $_;
    /**
     * Constructor method for tWeightHomeDeliveryExternal
     * @uses TWeightHomeDeliveryExternal::setUnit()
     * @uses TWeightHomeDeliveryExternal::set_()
     * @param string $unit
     * @param float $_
     */
     ...
     * @param string $unit
     * @return \Mjarestad\DHL\QuotePrice\StructType\TWeightHomeDeliveryExternal
     */
