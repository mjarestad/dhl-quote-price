...
/**
 * This class stands for tSenderReceiver_EC StructType
 * @subpackage Structs
 */
class TSenderReceiver_EC extends AbstractStructBase
{
    /**
     * The ImportExport
    ...
    public $ToPostCode;
    /**
     * Constructor method for tSenderReceiver_EC
     * @uses TSenderReceiver_EC::setImportExport()
     * @uses TSenderReceiver_EC::setFromCountryCode()
     * @uses TSenderReceiver_EC::setFromPostCode()
     * @uses TSenderReceiver_EC::setToCountryCode()
     * @uses TSenderReceiver_EC::setToPostCode()
     ...
     * @param string $importExport
     * @return \Mjarestad\DHL\QuotePrice\StructType\TSenderReceiver_EC
     */
