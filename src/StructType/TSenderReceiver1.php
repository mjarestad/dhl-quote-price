...
/**
 * This class stands for tSenderReceiver1 StructType
 * @subpackage Structs
 */
class TSenderReceiver1 extends AbstractStructBase
{
    /**
     * The FromPostCode
    ...
    public $ToCity;
    /**
     * Constructor method for tSenderReceiver1
     * @uses TSenderReceiver1::setFromPostCode()
     * @uses TSenderReceiver1::setFromCity()
     * @uses TSenderReceiver1::setToPostCode()
     * @uses TSenderReceiver1::setToCity()
     ...
     * @param string $fromPostCode
     * @return \Mjarestad\DHL\QuotePrice\StructType\TSenderReceiver1
     */
