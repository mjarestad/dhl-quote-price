...
/**
 * This class stands for tWeight6 StructType
 * @subpackage Structs
 */
class TWeight6 extends AbstractStructBase
{
    /**
     * The unit
    ...
    public $_;
    /**
     * Constructor method for tWeight6
     * @uses TWeight6::setUnit()
     * @uses TWeight6::set_()
     * @param string $unit
     * @param float $_
     */
     ...
     * @param string $unit
     * @return \Mjarestad\DHL\QuotePrice\StructType\TWeight6
     */
