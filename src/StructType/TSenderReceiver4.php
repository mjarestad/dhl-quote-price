...
/**
 * This class stands for tSenderReceiver4 StructType
 * @subpackage Structs
 */
class TSenderReceiver4 extends AbstractStructBase
{
    /**
     * The FromPostCode
    ...
    public $ToCity;
    /**
     * Constructor method for tSenderReceiver4
     * @uses TSenderReceiver4::setFromPostCode()
     * @uses TSenderReceiver4::setFromCity()
     * @uses TSenderReceiver4::setToPostCode()
     * @uses TSenderReceiver4::setToCity()
     ...
     * @param string $fromPostCode
     * @return \Mjarestad\DHL\QuotePrice\StructType\TSenderReceiver4
     */
